  ...
  return (
    <div className="w-full relative font-sans text-slate-800 overflow-x-hidden">
      ...
      >
        ...
        <div
          className="relative z-10 w-full max-w-[1440px] mx-auto px-6 lg:px-4 xl:px-12 flex flex-col lg:flex-row lg:items-stretch items-center"
          style={{ minHeight: "100svh" }}
        >
          {/* LEFT: Hero copy */}
          <div className="relative z-30 w-full lg:w-[46%] xl:w-[48%] flex flex-col justify-center pt-28 lg:pt-0 pb-16 lg:pb-0 shrink-0 lg:pl-0 lg:pr-8 lg:-ml-20 xl:-ml-24 text-left">
          ...
          <div
            className="hidden lg:block relative z-10 lg:w-[54%] xl:w-[52%] min-h-[700px]"
            style={{ height: "100svh" }}
          >
            <div
            ...
            <div
              className="absolute bg-white/82 backdrop-blur-2xl p-5 rounded-[2.2rem] shadow-2xl shadow-slate-300/40 border border-white/70 w-[220px] xl:w-[240px] animate-float"
              style={{
                top: "clamp(40px, 6.5vh, 90px)",
                left: "clamp(-200px, -11vw, -88px)",
                rotate: "3.5deg",
              }}
            >
            ...
            <div
              className="absolute bg-white/88 backdrop-blur-2xl p-6 rounded-[2.2rem] shadow-2xl shadow-slate-300/50 border border-white/70 w-[260px] xl:w-[276px] animate-float-delayed z-20"
              style={{
                top: "clamp(70px, 10vh, 130px)",
                right: "clamp(-240px, -12vw, -60px)",
                rotate: "-3deg",
              }}
            >
            ...
            <div
              ...
              style={{
                top: "clamp(330px, 50vh, 520px)",
                left: "clamp(180px, 24vw, 320px)",
                rotate: "5deg",
              }}
            >
